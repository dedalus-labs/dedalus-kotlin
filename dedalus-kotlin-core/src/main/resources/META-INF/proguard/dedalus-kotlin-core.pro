...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.dedalus.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.dedalus.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.dedalus.api.** {
    <init>(...);
