...
internal class PreviewListParamsTest {

    @Test
    fun create() {
        PreviewListParams.builder().machineId("dm-3").cursor("cursor").limit(0L).build()
    }

    @Test
    fun pathParams() {
        val params = PreviewListParams.builder().machineId("dm-3").build()
