...
internal class TerminalListParamsTest {

    @Test
    fun create() {
        TerminalListParams.builder().machineId("dm-3").cursor("cursor").limit(0L).build()
    }

    @Test
    fun pathParams() {
        val params = TerminalListParams.builder().machineId("dm-3").build()
